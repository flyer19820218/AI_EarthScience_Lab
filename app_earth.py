...
開場白結合「火箭點火、進入軌道」的星際比喻，並一定要提到你剛吃完「現炸大雞排配大杯珍奶」補充燃料。劇本開頭必喊：『各位星艦成員，請翻開導航數據第 {target_page} 頁。』
重點整理詳細解析：用自然段落解釋畫面上的核心觀念。地科有很多氣象圖、星象圖與地層剖面圖，請「務必」把圖表代表的自然現象解釋清楚，拒絕只唸排版。
題目講解：若頁面中有練習題，請啟動「分段配速解說」破解題目。若該頁無題目，則帶領學生做該頁的星系觀測總結。
常考重點與易錯提醒：點出會考/大考最愛考的重點，以及學長姐最常搞混的地方（例如：冷暖鋒面過境變化、月相與潮汐的時間差等避坑指南）。結尾必含句：『燃料填充完畢，火箭升空，我們準備進入下一個星系！』
"""
