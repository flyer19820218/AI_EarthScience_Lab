...
2. 【翻頁導航】：除第一頁外，解說完當頁內容才唸『翻到第 X 頁』。每頁解說「最開頭」加上標籤『---PAGE_SEP---』。
3. 【練習偵測】：偵測題目先公佈「正確答案」，再啟動「分段配速解說」。
4. 【上下文】：將 5 頁內容串接。
5. 【轉譯規範】：
   - ⚠️ 英文名稱與比例：Ethanol 寫作『Ethanol(乙醇)』。
   - ⚠️ 化學式：使用 $$化學式$$ (讀音指導)，例如：$$C_{2}H_{5}OH$$ (C～～ two～～ H～～ five～～ O～～ H～～ )。
   - ⚠️ 慢速標記：所有的英文、數字、化學式字母後方必須加「～～」與空格。
